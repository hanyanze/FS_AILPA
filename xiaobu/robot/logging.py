...
def getLogger(name):
    ...
    # FileHandler
    file_handler = RotatingFileHandler(os.path.join(constants.TEMP_PATH, 'xiaobu.log'), maxBytes=1024*1024,backupCount=5)
...
def readLog(lines=200):
    ...
    :returns: 最新指定行数的 log
    """
    log_path = os.path.join(constants.TEMP_PATH, 'xiaobu.log')
